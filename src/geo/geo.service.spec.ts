...
describe('GeoService', () => {
  ...
  describe('findAllRegiones', () => {
    it('retorna lista de regiones', async () => {
      ...
      expect(regionRepo.find).toHaveBeenCalledWith({ order: { nombre: 'ASC' } })
    })
  })
  ...
  describe('findOneRegion', () => {
    ...
    it('lanza NotFoundException si no existe', async () => {
      ...
      await expect(service.findOneRegion(99)).rejects.toThrow(NotFoundException)
    })
  })
  ...
  describe('updateRegion', () => {
    it('actualiza y retorna la región', async () => {
      ...
      regionRepo.save.mockResolvedValue({ ...mockRegion, nombre: 'Modificada' })
    ...
    it('lanza NotFoundException si no existe', async () => {
      ...
      await expect(service.updateRegion(99, { nombre: 'X' })).rejects.toThrow(NotFoundException)
    })
  })
  ...
  describe('findComunasByRegion', () => {
    ...
    it('lanza NotFoundException si la región no existe', async () => {
      regionRepo.findOneBy.mockResolvedValue(null)
      await expect(service.findComunasByRegion(99)).rejects.toThrow(NotFoundException)
    })
  })
  ...
  describe('findOneComuna', () => {
    ...
    it('lanza NotFoundException si no existe', async () => {
      ...
      await expect(service.findOneComuna(99)).rejects.toThrow(NotFoundException)
    })
  })
  ...
  describe('createComuna', () => {
    ...
    it('lanza NotFoundException si la región no existe', async () => {
      regionRepo.findOneBy.mockResolvedValue(null)
      await expect(service.createComuna({ nombre: 'X', regionId: 99 })).rejects.toThrow(
        NotFoundException,
      )
    })
  })
  ...
  describe('updateComuna', () => {
    it('actualiza y retorna la comuna', async () => {
      ...
      comunaRepo.save.mockResolvedValue({ ...mockComuna, nombre: 'Modificada' })
    ...
    it('lanza NotFoundException si la comuna no existe', async () => {
      ...
      await expect(service.updateComuna(99, { nombre: 'X' })).rejects.toThrow(NotFoundException)
    })

    it('lanza NotFoundException si la nueva región no existe', async () => {
      comunaRepo.findOneBy.mockResolvedValue(mockComuna)
      regionRepo.findOneBy.mockResolvedValue(null)
      await expect(service.updateComuna(1, { regionId: 99 })).rejects.toThrow(NotFoundException)
    })
  })
})
